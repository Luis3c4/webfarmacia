...
@Controller
public class ClienteController { // Cambié el nombre de la clase a PageController o algo más genérico si manejará más páginas
    ...
    public String mostrarPaginaProductos() { // Nombre de método descriptivo
        // Asumiendo que tienes una plantilla llamada "productos.html" en src/main/resources/templates/
    ...
    public String mostrarPaginaContacto() {
        // Asumiendo que tienes una plantilla llamada "contacto.html" en src/main/resources/templates/
        return "contacto";
    }
        @GetMapping("/registro")
